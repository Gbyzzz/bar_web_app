...
VALUES (1, 'Old Fashioned', 1, 0, '2022-10-25', null, 'В стакан олд фэшн кладём кусочек сахара, капаем на него Ангостуру и воду.' ||
       ...
       (2, 'Long Island Ice Tea', 2, 0, '2022-10-25', null, 'Наполняем бокал льдом и до половины — колой.' ||
